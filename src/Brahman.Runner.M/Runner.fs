module Brahman.Runner.Matrices
...
let matcher = new Brahman.MatrixMultiply.Matcher.Matcher()
...
let main argv =
    ...
    let res = matcher.Multiply ((Brahman.MatrixMultiply.MatrixReader.generate m n k), m, n, k)
